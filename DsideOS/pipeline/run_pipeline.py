...
# review/ is a per-paper WORKING folder (input JSON in, branded deliverables
# out) for one specific client's actual workflow — genuinely client-specific,
# same category as resources/ and templates/, so it stays under
# clients/target-academy/ even though this pipeline code itself (moved into
# DsideOS 2026-07-27) is generic. REPO_ROOT/parents[2] since this file sits
# at DsideOS/pipeline/run_pipeline.py.
REPO_ROOT = Path(__file__).resolve().parents[2]
CLIENT_DIR = REPO_ROOT / "clients" / "target-academy"
INPUT_DIR = CLIENT_DIR / "review" / "input"
OUTPUT_DIR = CLIENT_DIR / "review" / "output"
