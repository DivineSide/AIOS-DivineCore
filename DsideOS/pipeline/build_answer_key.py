...
# resources/ and templates/ are client-specific (client IP, gitignored) —
# stay under clients/target-academy/ even though this pipeline code (moved
# into DsideOS 2026-07-27) is generic. See DsideOS/.overview.md.
CLIENT_DIR = BASE.parent / "clients" / "target-academy"
FRONT_PAGE_DOCX = CLIENT_DIR / "resources" / "front-page.docx"
LOGO_IMG = CLIENT_DIR / "templates" / "docx_image1.jpeg"
