...
# resources/ is client-specific (see build_answer_key.py's CLIENT_DIR
# comment); corpus/ is generic, correctly lives under DsideOS/ itself.
CLIENT_DIR = BASE.parent / "clients" / "target-academy"
RES = CLIENT_DIR / "resources"
