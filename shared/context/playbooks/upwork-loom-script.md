...
## Variables to fill before recording

| Token | Source |
|---|---|
| `[Name]` | Buyer's name from the JD if present, drop the bracket if not |
| `[their ask]` | One-line summary of what they're hiring for |
| `[hook claim]` | Past-work claim — exact match / something close / softer fallback |
| `[niche tie]` | Their industry if you've genuinely worked in it, drop the clause if not |
| `[matching past workflow]` | The most relevant past-work workflow to pull up for the JD-specific demo |

---

## [0:00–0:30] OPEN

> Hello, thank you so much for watching this video. I understand you're looking for **[their ask]**.
>
> Actually, **[hook claim]** — for example: *"I built a workflow that looks something like this for a client of mine recently. They are a [niche tie]."*

---

## [0:30–1:30] JD-SPECIFIC PAST-WORK DEMO

> So I'll just quickly walk you through how it works, step by step.

**[Screen share → pull up the most relevant past-work workflow for this JD]**

> [Walk through the workflow, 30 to 45 seconds, focused on the parts that match THEIR ask. Don't deep-dive — just enough to prove "I've done this before."]

---

## [1:30–2:15] THE OFFER + GUARANTEE
...
> So that's my offer. Now let me walk you through how I actually differentiate myself from other AI automation freelancers on this platform.

---

## [2:25–3:05] THE CONTRAST

> The goal here is your team stops doing the repetitive work and has more time to focus on more important tasks. Right?
>
> Most people on Upwork calling themselves AI automation experts only know how to build one-off workflows. In my opinion, that's a thing of the past. I know how to build entire systems that basically run your whole business with you. They connect multiple workflows together and make decisions the way you would, because the system knows your business as well as you do.
>
> Other automation freelancers hand you a tool you have to babysit. The systems I build have a central brain that can do a lot of things on its own. For example: when a specific workflow breaks, it catches the error and fixes it without you having to step in.

---

## [3:05–3:25] THE METAPHOR

> I know this might sound kind of abstract, so here's the easiest way to think about it. Most freelancers sell you one workflow. That's like hiring one employee, one specialist inside your business. I sell you a business partner who knows everything about your business and never forgets a single thing. With a team of specialists running under them. Those specialists are the workflows.
...
## [5:10–5:40] TIE-BACK + FIRST STEP

> That's the difference. Other people sell you a specialist. I sell you a business partner with a team underneath.
>
> This is the best first step you can take to turn your business into an AI-first business. You're not just buying a tool. You're laying the foundation that everything compounds on. As we add more workflows across different departments (sales, ops, support, whichever you start with next), the brain only gets sharper, because the brain we build together keeps growing.

---

## [5:40–6:05] CLOSE

> I've drafted a proposal in my Upwork application. I put real time into it, so do take a look. Inside, you'll find my past case studies and a more detailed step-by-step of what I'll do for you. If everything looks good so far, just shoot me a reply and we'll move on to the next step.
>
> Thank you so much for watching this video, and I hope you have a great day.
...
## Simple-terms AIOS fallbacks (if [3:25–5:10] needs a tighter version or the buyer asks "wait, what's an AIOS?")

1. **"It's a system that runs your business with you because it knows your business as well as you do."**
2. **"It's a business partner who knows everything about your business and never forgets, with a team of specialists running under them."**
3. **"It's a copy of your business that can run itself."**

Pang's preferred order: lead with #1 or #2 (these match the metaphor section verbatim). Drop to #3 if a super-tight one-liner is needed mid-conversation.

---

## What this doc is, what it isn't

**It is:**
- The standardized Loom script for Upwork applications.
- A reference for any agent (future Sales OS module) that drafts Loom-related content.
- A living doc — revise after every 5–10 Looms with what's working / what's drifting.
